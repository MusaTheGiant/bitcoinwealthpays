...
(function () {
  ...
  form.addEventListener('submit', function (event) {
    ...
    var lines = [
      ...
      'Custom domain help: ' + ({'no':'No, included hosting','need-help':'Please quote domain setup','already-own':'I have a domain and need help connecting it'}[get('customDomainHelp')] || 'No, included hosting'),
