...
FAQ = [
 ...
 ('Getting help', [
  ...
  ('Can I get a copy of this website for myself or my team?', 'Yes. <a href="../request-a-copy/">Open the request form</a> for the same landing page, navigation and resource pages, personalized with your profile image, referral link and social links. The one-time fee is 32 USDT on TRON (TRC-20). Hosting on bitcoinwealthpays.com has no additional charge, and page updates are included for the lifetime of your copy. You can share a clear page that answers questions even when you are offline. Visitors and sign-ups are never guaranteed.'),
  ('Can I put my website copy on my own domain?', 'Yes. The 32 USDT base fee includes hosting on bitcoinwealthpays.com. If you prefer your own domain, select that option on the <a href="../request-a-copy/">request form</a>. We can help connect it for a small additional setup fee quoted before work begins. Buying and renewing a domain costs extra and is paid to your domain registrar.'),
