...
def panel():
  ...
  <p class="referral-note">This is a referral link, and the page owner may benefit if you register. Participation involves risk, and a wallet payment method does not guarantee earnings. Check the full address before connecting your wallet, and keep your recovery phrase private so you stay in control.</p>
</section>'''
...
def page(up, title, description, canonical, body, section=''):
    ...
    if slug != 'mtg':
        ...
        if slug != 'setup-guides':
            crumbs.append({'@type': 'ListItem', 'position': len(crumbs) + 1, 'name': 'Request a Copy' if slug == 'request-a-copy' else title.split(' | ')[-1], 'item': 'https://bitcoinwealthpays.com/' + canonical})
        elif len(crumbs) == 2:
            pass
        else:
...
landing = '''<main>
  ...
  <section class="mtg-sharing" aria-labelledby="sharing-title"><div class="premium-eyebrow">A different way to share</div><h2 id="sharing-title">Not comfortable recruiting or going live?</h2><p>You can give curious people a place to explore without a sales pitch. Bitcoin Wealth still depends on real paid activations, and an ad campaign cannot promise sign-ups. Your own copy of this website can explain the basics while a paid ClickBaitPays campaign may bring visitors to an approved link. Give interested people one clear place to watch, read and decide for themselves.</p><div class="mtg-sharing-actions"><a class="btn btn-ghost" href="faq/#question-i-cannot-recruit-or-go-live-is-there-another-way-to-share">See Your Sharing Options →</a><a class="btn btn-primary" href="request-a-copy/">Get Your Website Copy →</a></div></section>
  ''' + panel() + '''
  <section class="mtg-member-copy" aria-labelledby="copy-title"><div><h2 id="copy-title">Want a copy of this exact website for yourself or your team?</h2><p>For a one-time 32 USDT payment, get a mobile-friendly landing page, videos, FAQ, glossary and setup guides with your referral link, profile image and social links. Share one clear destination instead of explaining everything from scratch. Hosting on bitcoinwealthpays.com has no additional charge or monthly hosting fee, and updates to your page are included for its lifetime. Want your own domain? We can help set it up for a small additional fee quoted in advance; domain costs are separate.</p></div><a class="btn btn-ghost" href="request-a-copy/">Get Your Copy →</a></section>
  <section class="mtg-traffic" aria-labelledby="traffic-title"><div class="premium-eyebrow">For page owners</div><h2 id="traffic-title">Let your page be seen beyond your own feed.</h2><p>Keep your TikTok lives, videos and conversations if they work for you. A separate ClickBaitPays ad campaign can place an approved link in front of participating viewers, including people you may never meet; visitors and registrations are not guaranteed. Qualifying ad views may separately earn USDT under its rules, with campaign costs, activity and withdrawal terms to check. Explore both options to see how they could fit the way you share.</p><a class="btn btn-primary" href="https://clickbaitpaysus.com/" target="_blank" rel="noopener noreferrer">Learn How ClickBaitPays Works →</a></section>
  <aside class="mtg-deeper">Prefer the full explanation? Read the complete 17 lesson Bitcoin Wealth course at your own pace.<div class="mtg-deeper-actions"><a class="btn btn-quiet" href="../">Explore The Full Course →</a><a class="btn btn-ghost" href="''' + PDF_DOWNLOAD + '''" target="_blank" rel="noopener noreferrer">Download PDF Slides ↓</a></div></aside>
</main>'''
...
request_body = '''<main class="subbody mtg-order"><div class="crumbs"><a href="../">Home</a> &rsaquo; <b>Request a Copy</b></div>
  ...
  <div class="mtg-order-overview"><div><strong>32 USDT once</strong><span>One-time setup; no monthly website service fee</span></div><div><strong>Hosting included</strong><span>No additional hosting charge for your page on bitcoinwealthpays.com</span></div><div><strong>Lifetime updates</strong><span>Changes to your page at no further service fee for the lifetime of your page</span></div><div><strong>Ready to share</strong><span>Mobile-friendly pages, videos, FAQs and guides with your image, referral and social links</span></div></div>
  <p class="mtg-order-domain">Want your own domain instead? We can help connect it for a small additional setup fee, quoted before work begins. You pay any domain purchase and renewal charges separately to your registrar.</p>
  <section class="mtg-payment" aria-labelledby="payment-title"><div class="premium-eyebrow">Step 1 of 2 · Make your payment</div><h2 id="payment-title">Send exactly 32 USDT on TRON (TRC-20).</h2><p>Use the TRON (TRC-20) network only. Double-check the full address in your wallet before sending. If your exchange deducts a withdrawal fee, make sure the amount received is 32 USDT. Keep your transaction ID and a screenshot or PDF of your payment confirmation. Please pay only the base website fee now; we will quote optional domain setup separately.</p>
  ...
  <section class="mtg-order-form-area" aria-labelledby="form-title"><div class="premium-eyebrow">Step 2 of 2 · Tell us what to customize</div><h2 id="form-title">Complete your request after paying.</h2><p>The fields below prepare a message to <strong>MTG 👑</strong> on WhatsApp. Your browser cannot attach these files automatically: after WhatsApp opens, add the selected image and proof of payment there and press Send.</p>
    <form id="copy-request-form" data-copy-request>
      ...
      <fieldset><legend>Your page details</legend>
        ...
        <div class="mtg-form-grid"><label>Would you like help with a custom domain? <select name="customDomainHelp"><option value="no">No, use the included bitcoinwealthpays.com hosting</option><option value="need-help">Yes, please quote domain setup</option><option value="already-own">Yes, I already have a domain</option></select></label><label>Your domain name, if you have one <span class="mtg-optional">optional</span><input name="customDomainName" type="text" maxlength="150" placeholder="example.com" autocomplete="off"><small>We will discuss the optional setup fee before proceeding.</small></label></div>
      ...
      <fieldset><legend>Payment confirmation</legend>
        ...
        <label class="mtg-checkbox"><input name="paymentConfirmed" type="checkbox" required><span>I have sent 32 USDT on TRON (TRC-20) to the address above, and I will attach my payment proof in WhatsApp before sending this request.</span></label>
      </fieldset>
  ...
  <section class="mtg-order-questions"><h2>Before you send</h2><p>Your one-time 32 USDT covers setup, this layout and resource pages, your selected profile image, referral address and social links. Hosting on bitcoinwealthpays.com has no additional charge, and updates to your page are included for its lifetime. We start after matching your payment to your request; we will contact you on WhatsApp if any detail is missing. Custom domain setup is available for a small additional fee quoted separately.</p><a href="../faq/">Read The Bitcoin Wealth FAQ →</a></section>
  <section class="mtg-traffic" aria-labelledby="traffic-title"><div class="premium-eyebrow">After your page is ready</div><h2 id="traffic-title">Your page can explain. Advertising can help people find it.</h2><p>Keep doing what works for you: TikTok lives, videos, posts and conversations. If recruiting or going live feels difficult, your page gives people a place to explore at their own pace. ClickBaitPays offers a separate way to put an approved link in front of participating viewers.</p><div class="mtg-traffic-ways"><div><strong>Help people discover your page</strong><p>Run a paid campaign pointing to your Bitcoin Wealth page or another offer you promote, subject to content and destination approval. A viewer can open the link, learn and decide for themselves. Some may register; many may not.</p></div><div><strong>Explore ad-viewing rewards</strong><p>Separately, ClickBaitPays advertises USDT rewards for members who complete qualifying ad views. This is separate from Bitcoin Wealth payouts and is not guaranteed income. Review its activity, fees and withdrawal rules to see how it works.</p></div></div><p class="mtg-traffic-note">Campaign costs are separate from the 32 USDT website-copy service. Advertising can create exposure, but it cannot promise sign-ups or a completed Bitcoin Wealth cycle. Learn the campaign rules and decide how you want to share your page.</p><a class="btn btn-primary" href="https://clickbaitpaysus.com/" target="_blank" rel="noopener noreferrer">See How ClickBaitPays Works →</a></section>
</main>
<script src="../copy-request.js?v=5" defer></script>'''
(OUT / 'request-a-copy').mkdir(exist_ok=True)
(OUT / 'request-a-copy/index.html').write_text(page('../', 'Request a Copy of This Bitcoin Wealth Website | 32 USDT', 'Request a personalized Bitcoin Wealth website with your referral and social links. One-time 32 USDT on TRON, hosting on bitcoinwealthpays.com and lifetime page updates included.', 'mtg/request-a-copy/', request_body, 'request'))
