...
<link rel="stylesheet" href="{up}../style.css?v=20260926b"><link rel="stylesheet" href="{up}style.css?v=20260926b">
...
landing = '''<main>
  ...
  <section class="mtg-traffic" aria-labelledby="traffic-title"><div class="premium-eyebrow">For page owners</div><h2 id="traffic-title">Give your page another way to be seen.</h2><p>Alongside TikTok lives, short videos and the places you already share, ClickBaitPays offers paid campaigns that can show an approved page or link to participating viewers. It also offers a separate option to earn rewards for viewing ads under its rules. Check campaign costs and participation terms before you join; traffic, sign-ups and earnings are not guaranteed.</p><a class="btn btn-primary" href="https://clickbaitpaysus.com/" target="_blank" rel="noopener noreferrer">Explore ClickBaitPays →</a></section>
...
request_body = '''<main class="subbody mtg-order"><div class="crumbs"><a href="../">Home</a> &rsaquo; <b>Request a Copy</b></div>
  <div class="mtg-subhead"><div class="premium-eyebrow">Your own Bitcoin Wealth page</div><h1>A page for you or your team.</h1><p>Your own profile image, referral link and social links, set up on a separate member page.</p></div>
  ...
  <section class="mtg-order-questions"><h2>Before you send</h2><p>Your copy includes a personalized profile image, referral address and selected social links. Updates to your page are included for its lifetime. We start after matching your payment to your request; we will contact you on WhatsApp if any detail is missing.</p><a href="../faq/">Read the Bitcoin Wealth FAQ →</a></section>
  <section class="mtg-traffic" aria-labelledby="traffic-title"><div class="premium-eyebrow">After your page is ready</div><h2 id="traffic-title">More ways to share. Another option to explore.</h2><p>Keep doing what works for you: TikTok lives, videos, posts, personal conversations and your existing groups. ClickBaitPays offers an additional advertising channel and a separate way to participate as a viewer.</p><div class="mtg-traffic-ways"><div><strong>Put your page in front of viewers</strong><p>Create a paid ad campaign that points to your Bitcoin Wealth page or another offer you promote, subject to the platform approving your content and destination. Participating viewers can discover your page and decide whether to visit.</p></div><div><strong>Explore viewing rewards</strong><p>ClickBaitPays also describes rewards for members who view ads and meet its activity rules. This is separate from your Bitcoin Wealth page and its referral programme. Check the fees, withdrawal rules and risks before taking part.</p></div></div><p class="mtg-traffic-note">Campaign spending is separate from the $20 page service. Advertising brings possible exposure, not a guaranteed audience match or sign-ups. Viewing activity does not guarantee profit or a second income.</p><a class="btn btn-primary" href="https://clickbaitpaysus.com/" target="_blank" rel="noopener noreferrer">See how ClickBaitPays works →</a></section>
</main>
<script src="../copy-request.js?v=3" defer></script>'''
